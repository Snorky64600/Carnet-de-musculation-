...
class _ChronoBottomSheetState extends State<ChronoBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    double progress = (_isLibre || _targetSeconds == 0) ? 1.0 : (_secondsRemaining / _targetSeconds);
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          const Text("Chrono de Récupération", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.blueAccent)),
          ...
          Stack(
            ...
            children: [
              ...
              Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Text(_formatTime(displaySeconds), style: const TextStyle(fontSize: 42, fontWeight: FontWeight.bold, color: Colors.white)),
                  Text(_isLibre ? "Mode Libre" : "Temps de repos", style: const TextStyle(color: Colors.grey, fontSize: 13)),
                ],
              ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              IconButton(iconSize: 36, icon: const Icon(Icons.refresh, color: Colors.grey), onPressed: _reset),
              ...
              const SizedBox(width: 24),
              IconButton(iconSize: 36, icon: const Icon(Icons.close, color: Colors.grey), onPressed: () => Navigator.pop(context)),
            ],
          ),
          const SizedBox(height: 10),
        ],
